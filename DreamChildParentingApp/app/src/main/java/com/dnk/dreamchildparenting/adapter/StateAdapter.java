...
public class StateAdapter extends RecyclerView.Adapter<StateAdapter.ViewHolder> {
    ...
    public StateAdapter(Activity activity, ArrayList<DataModel> listData, int position, BottomSheetDialog dialog) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.txtTitle.setText(Html.fromHtml(dataModel.state_name));
        viewHolder.txtCountryCode.setText(dataModel.state_code);
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (activity instanceof SignUpActivity) {
                    ((SignUpActivity) activity).stateData.setSelected(dataModel);
                }
                dialog.dismiss();
            }
        });
